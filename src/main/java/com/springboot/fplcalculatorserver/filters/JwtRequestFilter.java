...
import com.springboot.fplcalculatorserver.exceptions.MyJwtException;
...
public class JwtRequestFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      ...
      System.out.println(malformedJwtException.getMessage()); // to do return apiresponse with error
    } catch (UsernameNotFoundException e) {
      System.out.println(e.getMessage()); // to do return apiresponse with error message
    } catch (SignatureException e) {
      System.out.println(e.getMessage()); // to do return apiresponse with error message
      throw new MyJwtException(ErrorCode.INVALID_JWT_SIGNATURE.getMsg(),
